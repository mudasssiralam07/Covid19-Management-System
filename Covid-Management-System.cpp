...
protected:
    ...
    int tm;
    // FOR VACCINE CENTER
    string center1 = "center-1";
    string center2 = "center-2";
    string center3 = "center-3";
...
void covid_management::admin_password()
{
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name, "mudassir") == 0) && (strcmp(a_password, "12345") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
